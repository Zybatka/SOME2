...
import edu.platform.security.CustomUserDetailsService;
import edu.platform.security.JwtAuthenticationEntryPoint;
import edu.platform.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
            ...
            .authorizeHttpRequests(authz -> authz
                ...
                // Media endpoints
                .requestMatchers(HttpMethod.POST, "/api/media").hasAnyRole("STUDENT", "TEACHER", "ADMIN")
                .requestMatchers(HttpMethod.GET, "/api/media/**").hasAnyRole("STUDENT", "TEACHER", "ADMIN")
